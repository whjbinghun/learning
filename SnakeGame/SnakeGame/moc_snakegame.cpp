...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SnakeGame_t, stringdata) + ofs \
...
const QMetaObject SnakeGame::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SnakeGame.data,
      qt_meta_data_SnakeGame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SnakeGame.stringdata))
