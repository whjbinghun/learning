...
#include "../../PictureShow/pictureshow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PictureShow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 5)
    ...
    "PictureShow\0setLineEditValue\0\0value\0"
};
...
void PictureShow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PictureShow *_t = static_cast<PictureShow *>(_o);
        switch (_id) {
...
const QMetaObject PictureShow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PictureShow.data,
      qt_meta_data_PictureShow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PictureShow.stringdata))
        return static_cast<void*>(const_cast< PictureShow*>(this));
